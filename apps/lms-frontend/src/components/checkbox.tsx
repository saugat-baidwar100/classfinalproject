      ...
      <div className="w-full bg-gradient-to-r from-blue-100 to-purple-100 px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 md:py-10 rounded-xl flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <button
            ...
            className="w-full sm:w-auto px-4 sm:px-5 py-2 text-sm sm:text-base md:text-lg border-2 border-teal-500 text-teal-500 font-semibold font-poppins rounded-lg hover:bg-teal-500 hover:text-white transition-all duration-200"
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 sm:px-5 py-2 text-sm sm:text-base md:text-lg bg-teal-500 text-white font-semibold font-poppins rounded-lg hover:bg-teal-600 transition-all duration-200"
