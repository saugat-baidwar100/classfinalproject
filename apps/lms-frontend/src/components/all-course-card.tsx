...
export const AllCourseCard: React.FC<AllCourse> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row flex-wrap rounded-[20px] border border-[#EAEAEA] overflow-hidden group cursor-pointer transition-transform duration-300 ease-in-out hover:shadow-lg hover:scale-102 hover:bg-custom-teal">
      {/* Image Section */}
      <div className="w-full sm:w-1/3 aspect-[4/3] overflow-hidden">
        <img
      ...
      <div className="w-full sm:w-2/3 p-4">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 items-start sm:items-center mb-2">
